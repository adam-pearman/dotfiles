      ...
      sources = {
        null_ls.builtins.diagnostics.eslint_d.with({
          condition = function(utils)
            return utils.root_has_file({ '.eslintrc.js', '.eslintrc.cjs', 'src/.eslintrc.js', 'src/.eslintrc.cjs' })
          end
        }),
        -- null_ls.builtins.diagnostics.phpstan.with({
        --   condition = function(utils)
        --     return utils.root_has_file({ 'vendor/bin/phpstan', 'src/vendor/bin/phpstan' })
        --   end,
        -- }),
        ...
        null_ls.builtins.formatting.pint.with({
          condition = function(utils)
            return utils.root_has_file({ 'vendor/bin/pint', 'src/vendor/bin/pint' })
          end,
        }),
